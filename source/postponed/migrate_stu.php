				...
				<tr>
					...
					<td>
						<select name="id">
							...
							// print out the data in the select option
							// put one blank option
							?>
							<option>--Choose a student--</option>
							<?php
							for($print=0; $print<count($data); $print++){
								?>
								<option value="<?php echo $data[$print]["stu_id"]; ?>"><?php echo $data[$print]["actual_name"]; ?></option>
								<?php
							}
							?>
						</select>
